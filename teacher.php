   ...
   <!-- Fixed navbar -->
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
		...
		<img src="pictlogo.jpg" alt="Welcome to PICT" width="70" height="70" >
    <h2><a class="navbar-brand" href="index.php" style="font-size:28px;">Pune Institute of Computer Technology</a></h2>
